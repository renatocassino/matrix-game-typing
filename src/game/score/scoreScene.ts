...
import type { CustomWindow } from '../common/types/commonTypes';
import { MenuScene } from '../menu/menuScene';
import type { ScoreStatus } from '../round/components/scoreComponent';
...
export class ScoreScene extends Phaser.Scene {
  ...
  addScoreStatus() {
    ...
    this.add
      .image(boardWidth / 2, boardHeight / 2, assets.ui.CARD)
      .setScale(0.7)
      .setAlpha(0.6);
    ...
    this.add
      .text(boardWidth / 2, boardHeight / 2 - 200, 'Score', {
        font: '32px Orbitron',
        color: '#fff'
      })
      .setOrigin(0.5, 0.5);
