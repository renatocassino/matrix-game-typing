...
export const levels = [
  ...
  new TrainingLevel('LKJH', 'LKJH', level++, [
    ...
    {
      words: ['lala', 'kada', 'saha', 'salada', 'lakada', 'lajaha', 'shala', 'lakasa', 'lakafa', 'fakada', 'lasaja', 'lasada', 'alkaja'],
      wordsToFall: 15,
    },
    {
      words: ['laskada', 'hajada', 'dakada', 'kakasla', 'lajaka', 'jaka', 'hakasla', 'lakasaja', 'lafakada'],
      wordsToFall: 15,
    },
  ]),
  new TrainingLevel('Middle line', 'ASDFGLKJH', level++, [
    {
      words: ['alg', 'ash', 'ask', 'las', 'hal', 'gad', 'gaf', 'gak', 'lag', 'lad', 'sad', 'gaj', 'sla', 'fka', 'gha', 'dak', 'jaf'],
      wordsToFall: 15,
    },
    {
      words: ['alga', 'slag', 'lads', 'saja', 'daka', 'salk', 'fala', 'lash', 'faha', 'faka', 'faja', 'gaga', 'ghak', 'hjak', 'lhak', 'lhad', 'kahd', 'jsfg'],
      wordsToFall: 15,
    },
    {
      words: ['lasha', 'shaka', 'shala', 'lhaka', 'fhada', 'galha', 'dhala', 'shakl', 'laska', 'jhada', 'gakla', 'dafla', 'flash', 'slash'],
      wordsToFall: 15,
    },
    {
    ...
    {
      words: ['fadalda', 'fafakala', 'lakadsa', 'jashalaka', 'galhakas', 'hakalak', 'daklash', 'safadala', 'kalahsha'],
      wordsToFall: 15,
    },
  ]),
  ...
  new TrainingLevel('First and second line', '', level++, [
    {
      words: ['a', 's', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p'],
      wordsToFall: 25,
    },
    {
      words: ['we', 'as', 'at', 'rat', 'so', 'art', 'tea', 'ship', 'oil', 'up', 'lip', 'out', 'pie', 'tap'],
      wordsToFall: 25,
    },
    {
      words: ['rate', 'date', 'ship', 'yolk', 'hike', 'kite', 'sight', 'duke', 'haste', 'joke', 'ripe'],
      wordsToFall: 25,
    },
    {
      words: ['right', 'dairy', 'hairy', 'joust', 'youth', 'leak', 'soil', 'drape', 'loud', 'quiet', 'rake', 'spike'],
      wordsToFall: 25,
    },
    {
      words: ['drought', 'sprout', 'hurdle', 'stored', 'stride', 'lashed', 'spiked', 'haste', 'slight', 'joked'],
      wordsToFall: 25,
    },
    {
      words: ['outride', 'plaster', 'jousted', 'shaped', 'lied', 'ploughed', 'shorted', 'hiked', 'kilo', 'jail'],
      wordsToFall: 25,
    },
  ]),
  ...
  new TrainingLevel('Left hand Full', 'QWERTASDFGZXCVB', level++, [
    ...
    {
      words: ['as', 'at', 'rat', 'art', 'tea', 'tar', 'tad', 'bad', 'bet', 'wad', 'wet', 'bed', 'bat', 'vet', 'vex', 'wax', 'tax', 'gas', 'zag', 'tag'],
      wordsToFall: 15,
    },
    {
      words: ['rate', 'dart', 'dear', 'wear', 'wade', 'fade', 'gate', 'date', 'vest', 'best', 'rest', 'west', 'sage', 'rage'],
      wordsToFall: 15,
    },
    {
      words: ['great', 'bread', 'grade', 'trade', 'waste', 'bread', 'gated', 'rated', 'crate', 'brave', 'trace', 'beast'],
      wordsToFall: 15,
    },
    {
  ...
  new TrainingLevel('Right Hand Full', 'POIUYLKJHMN', level++, [
    ...
    {
      words: ['up', 'on', 'in', 'no', 'you', 'oil', 'joy', 'yup', 'lip', 'hop', 'lop', 'yon', 'pin', 'pun', 'mop', 'nil', 'yolk'],
      wordsToFall: 15,
    },
    {
      words: ['join', 'link', 'pink', 'yolk', 'yup', 'holy', 'punk', 'milk', 'ploy', 'lynk', 'monk', 'lion', 'limp', 'lump', 'yolk', 'limn', 'plum'],
      wordsToFall: 15,
    },
    {
    ...
    {
      words: ['joypin', 'unlink', 'monkey', 'unplug', 'jumpy', 'plumpy', 'linky', 'hopkin', 'plumy'],
      wordsToFall: 15,
    },
  ]),
  new TrainingLevel('Full keyboard', 'QWERTYUIOPASDFGHJKLZXCVBNM', level++, [
    {
      words: ['the', 'quick', 'brown', 'keyboard', 'layout', 'typing', 'practice', 'example', 'words', 'english'],
      wordsToFall: 25,
    },
    {
      words: ['computer', 'language', 'function', 'variable', 'keyboard', 'programming', 'string', 'integer', 'database', 'network'],
      wordsToFall: 25,
    },
    {
      words: ['object', 'oriented', 'javascript', 'framework', 'application', 'development', 'platform', 'server', 'client', 'webpage'],
      wordsToFall: 25,
    },
    {
      words: ['design', 'frontend', 'backend', 'middleware', 'architecture', 'interface', 'hardware', 'software', 'plugin', 'template'],
      wordsToFall: 25,
    },
    {
      words: ['protocol', 'algorithm', 'encryption', 'validation', 'authentication', 'integration', 'optimization', 'visualization', 'interaction', 'navigation'],
      wordsToFall: 25,
    },
    {
      words: ['frameworks', 'libraries', 'components', 'modules', 'functions', 'variables', 'instances', 'properties', 'methods', 'events'],
      wordsToFall: 25,
    },
  ]),
];
